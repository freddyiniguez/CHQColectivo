...
require_once( get_template_directory() . '/core/plugins/layerslider.php' );
require_once( get_template_directory() . '/core/plugins/woocommerce.php' );
require_once( get_template_directory() . '/core/post-types/post-type-news.php' );
require_once( get_template_directory() . '/core/post-types/post-type-portfolio.php' );
require_once( get_template_directory() . '/core/post-types/post-type-slideshow.php' );
require_once( get_template_directory() . '/core/add-image-size.php' );
...
require_once( get_template_directory() . '/core/lang.php' );
require_once( get_template_directory() . '/core/menus.php' );
require_once( get_template_directory() . '/core/nav.php' );
require_once( get_template_directory() . '/core/search.php' );
...
function flow_scripts() {
	...
	wp_enqueue_script( 'infinite-scroll', get_template_directory_uri() . '/modules/library-isotope/jquery.infinitescroll.min.js', array( 'jquery' ), '2.0b2.120519', true );
	...
	wp_enqueue_style( 'flow-fontawesome', get_template_directory_uri() . '/modules/fonts/fontawesome/font-awesome.css' );
